...
@RestController
public class Redfish_V1_Systems_1_OEM_Lenovo_Metrics_InletAirTemp_Controller {
    @RequestMapping(path = "/redfish/v1/Systems/1/Oem/Lenovo/Metrics/InletAirTemp", produces = MediaType.APPLICATION_JSON_VALUE)
    public String InletAirTemp(Generate_Power_Metrics generate) throws JSONException {
        return generate.generatePowerMeteringData(25, 25, 60, true, "InletAirTemp");
    }
}
