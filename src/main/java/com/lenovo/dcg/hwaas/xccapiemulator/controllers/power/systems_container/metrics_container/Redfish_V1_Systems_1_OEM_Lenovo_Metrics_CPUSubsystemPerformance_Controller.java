...
@RestController
public class Redfish_V1_Systems_1_OEM_Lenovo_Metrics_CPUSubsystemPerformance_Controller {
    ...
    public String CPUSubsystemPerformance(Generate_Power_Metrics generate) throws JSONException {
        return generate.generatePowerMeteringData(0, 0, 120, false, "CPUSubsystemPerformance");
    }
}
