...
@RestController
public class Redfish_V1_Systems_1_OEM_Lenovo_Metrics_PowerSupplyOutputPower2_Controller {
    ...
    public String PowerSupplyOutputPower2(Generate_Power_Metrics generate) throws JSONException {
        return generate.generatePowerMeteringData(0, 0, 120, false, "PowerSupplyOutputPower2");
    }
}
