...
@RestController
public class Redfish_V1_Systems_1_OEM_Lenovo_Metrics_SystemPerformance_Controller {
    @RequestMapping(path = "/redfish/v1/Systems/1/Oem/Lenovo/Metrics/SystemPerformance", produces = MediaType.APPLICATION_JSON_VALUE)
    public String SystemPerformance(Generate_Power_Metrics generate) throws JSONException {
        return generate.generatePowerMeteringData(0, 0, 120, true, "SystemPerformance");
    }
}
