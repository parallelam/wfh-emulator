...
@RestController
public class Redfish_V1_Systems_1_OEM_Lenovo_Metrics_MemorySubsystemPower_Controller {
    ...
    public String MemorySubsystemPower(Generate_Power_Metrics generate) throws JSONException {
        return generate.generatePowerMeteringData(999, 1, 120, true, "MemorySubsystemPower");
    }
}
