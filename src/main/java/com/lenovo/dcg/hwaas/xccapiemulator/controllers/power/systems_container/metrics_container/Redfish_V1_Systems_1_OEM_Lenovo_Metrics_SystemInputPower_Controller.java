...
@RestController
public class Redfish_V1_Systems_1_OEM_Lenovo_Metrics_SystemInputPower_Controller {

    @RequestMapping(path = "/redfish/v1/Systems/1/Oem/Lenovo/Metrics/SystemInputPower", produces = MediaType.APPLICATION_JSON_VALUE)
    public String SystemInputPower(Generate_Power_Metrics generate) throws JSONException {
        return generate.generatePowerMeteringData(999, 1, 120, true, "SystemInputPower");
    }
